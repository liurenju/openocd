...
static const struct {
	...
	{ ARMV8_R0,  "r0",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R1,  "r1",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R2,  "r2",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R3,  "r3",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R4,  "r4",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R5,  "r5",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R6,  "r6",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R7,  "r7",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R8,  "r8",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R9,  "r9",  64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R10, "r10", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R11, "r11", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R12, "r12", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R13, "r13", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R14, "r14", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R15, "r15", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R16, "r16", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R17, "r17", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R18, "r18", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R19, "r19", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R20, "r20", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R21, "r21", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R22, "r22", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R23, "r23", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R24, "r24", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R25, "r25", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R26, "r26", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R27, "r27", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R28, "r28", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R29, "r29", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_R30, "r30", 64, REG_TYPE_INT, "general", "org.gnu.gdb.arm.m-profile" },

	{ ARMV8_R31, "sp", 64, REG_TYPE_DATA_PTR, "general", "org.gnu.gdb.arm.m-profile" },
	{ ARMV8_PC,  "pc", 64, REG_TYPE_CODE_PTR, "general", "org.gnu.gdb.arm.m-profile" },
...
static int armv8_set_core_reg(struct reg *reg, uint8_t *buf)
{
	struct arm_reg *armv8_reg = reg->arch_info;
	struct target *target = armv8_reg->target;
	struct arm *armv8_target = target_to_arm(target);
	uint64_t value = buf_get_u64(buf, 0, 64);

	if (target->state != TARGET_HALTED)
		return ERROR_TARGET_NOT_HALTED;

	if (reg == armv8_target->cpsr) {
		arm_set_cpsr(armv8_target, (uint32_t)value);
	} else {
